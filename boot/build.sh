...
Usage:
  boot/build.sh                    build into boot/out/
...
# never through this stub. We only put `console=ttyS0 console=tty0`
...
EFI_CMDLINE="${ZBOOT_BOOT_CMDLINE:-console=ttyS0 console=tty0}"
